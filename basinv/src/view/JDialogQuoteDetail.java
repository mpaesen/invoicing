	...
	private void initGUI() {

		{
			...
			this.setBounds(0, 0, 462, 362);
			{
				...
				TableLayout jPanelQuoteDetailLayout = new TableLayout(new double[][] {{104.0, 68.0, 102.0, 111.0, TableLayoutConstants.FILL}, {25.0, 28.0, 29.0, 25.0, 25.0, TableLayoutConstants.FILL}});
