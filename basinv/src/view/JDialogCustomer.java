...
public class JDialogCustomer extends JDialog {
	...
	private void buildJPanelCustomerDetails(Customer customer) {
		...
		// Tablelayout
		TableLayout jPanelCustomerDetailsLayout = new TableLayout(new double[][] {{151.0, 161.0, TableLayoutConstants.FILL, TableLayoutConstants.FILL}, {20.0, 20.0, 20.0, 20.0, 20.0, 20.0, 20.0, TableLayoutConstants.FILL, TableLayoutConstants.FILL, TableLayoutConstants.FILL, 20.0, 20.0, 20.0, 20.0, 20.0}});
