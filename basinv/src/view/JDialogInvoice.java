	...
	private void invoiceHeaderNorthPanel() {
		{// North panel
			...
			TableLayout jPanelHeaderNorthLayout = new TableLayout(
					new double[][] {
							{ 134.0, 158.0, 172.0, 40.0, TableLayoutConstants.FILL },
		...
		{// South Panel
			...
			TableLayout jPanelHeaderSouthLayout = new TableLayout(
					new double[][] {
							...
							{ 27.0, 28.0, 46.0, TableLayoutConstants.FILL } });
	...
	public JPanel getJPanelInvoiceTotal() {
		if (jPanelInvoiceTotal == null) {
			...
			TableLayout jPanelInvoiceTotalLayout = new TableLayout(
					new double[][] {
							{ 451.0, 162.0, 62.0, TableLayoutConstants.FILL },
							{ 7.0, TableLayoutConstants.FILL, TableLayoutConstants.FILL,
									TableLayoutConstants.FILL, TableLayoutConstants.FILL, 7.0 } });
