...
public class DummyCustomer extends Dummy {
    ...
    public static String[] cclass = {"Indu", "Land", "Part"};
    ...
    public static Customer createCustomer() {
        ...
        return new Customer(
                ...
                NumberController.readLastNumber("Cus", 0).toString(), lName, // this.cusName
                // =
                // cusName;
                "BE0"
                ...
                "Services", "BE40652820977063", "Info", true // this.active =
                // active;
        );
    }
}
