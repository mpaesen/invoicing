...
public class DummyFactory {
    public static Business createBusiness(BusinessTypeEnum businessTypeEnum) {
        ...
        switch (businessTypeEnum.getSeq()) {
            ...
            case 5: {
                object = DummyCustomer.createCustomer();
                object2 = DummyAddress
                        .createAddress(((Customer) object).getIdCus());
                object = DummyQuote.createQuote(((Customer) object).getIdCus(),
                        ((Address) object2).getIdAddress());
                break;
            }
            case 6: {
                object = DummyCustomer.createCustomer();
                ...
                object = DummyQuoteDetail.createQuoteDetail(
                        ((Quote) object).getIdQuote(),
                        ((Product) object2).getIdProd());
                break;
            }
            case 7: {
                object = DummyCustomer.createCustomer();
                object2 = DummyAddress
                        .createAddress(((Customer) object).getIdCus());
                object = DummyInvoice.createInvoice(
                        ((Customer) object2).getIdCus(),
                        ((Address) object2).getIdAddress());
                break;
            }
            case 8: {
                ...
                object2 = DummyAddress
                        .createAddress(((Customer) object).getIdCus());
                object = DummyInvoice.createInvoice(((Customer) object).getIdCus(),
                        ((Address) object2).getIdAddress());
                object2 = DummyProduct.createProduct();
                object = DummyInvoiceDetail.createInvoiceDetail(
                        ((Invoice) object).getIdInvoice(),
                        ((Product) object2).getIdProd());
                break;
            }
            case 9: {
