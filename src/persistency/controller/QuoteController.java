...
public class QuoteController {
     ...
     * @throws Exception
     */
    public static void prepareQuote(Quote quote, Object[] args, int[] argsType,
    ...
    public static boolean createQuote(Quote quote) {
        ...
        for (int i = 0; i < args.length; i++) {
            try {
                ...
                BaseLogger.getLogger().logMsg(String.format(callableStatement + quote.toString()));
            }
        }
        ...
        for (int i = 0; i < args.length; i++) {
            try {
                switch (i) {
                    ...
                    default:
                        throw new Exception("Error while creating SP removeQuote()");
                }
