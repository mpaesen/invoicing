...
public class CodeController {
    ...
    public static CodeDetail getOneCodeDetail(String ref, String det) {
        ...
        Collection<Business> list = facade.getResult(
                BusinessTypeEnum.CODE_DETAIL, callableStatement.toString(),
     ...
     * @throws Exception
     */
    public static void prepareCode(CodeDetail detail, Object[] args,
    ...
    public static boolean createCode(CodeDetail detail) {
        int LENGTH = 4;
        callableStatement = new StringBuilder();
        callableStatement.append("{call createCodeDetail(?, ?, ?, ?)}");
        facade = new DBFacade();
        Object[] args = new Object[LENGTH];
        int[] argsType = new int[LENGTH];
        ArgIO[] argsIO = new ArgIO[LENGTH];
    ...
    public static boolean updateCode(CodeDetail detail) {
        int LENGTH = 4;
        callableStatement = new StringBuilder();
        callableStatement.append("{call updateCodeDetail(?, ?, ?, ?)}");
        facade = new DBFacade();
        Object[] args = new Object[LENGTH];
        int[] argsType = new int[LENGTH];
        ArgIO[] argsIO = new ArgIO[LENGTH];
        ...
        for (int i = 0; i < args.length; i++) {
            try {
                switch (i) {
                    ...
                    default:
                        throw new Exception(
                                "Error while creating SP removeCodeDetail()");
                }
