...
public class InvoiceDetailController {
    ...
    public static void createNewCreditNoteDetails(Invoice creditNote,
                                                  Invoice invoice) {
    ...
    private static void createDetail(Invoice invoice, QuoteDetail detail) {
        InvoiceDetail newDetail = new InvoiceDetail(invoice.getIdInvoice(),
                detail.getQteDetLine(), detail.getQteProdid(),
                detail.getQteQty(), detail.getQteMeasure(),
                detail.getQtePrice(), Figures.ZERO_STRING,
                detail.getQteComments(), true);
        createInvoiceDetail(newDetail);
    }

    private static void createDetail(Invoice invoice, InvoiceDetail detail) {
        InvoiceDetail newDetail = new InvoiceDetail(invoice.getIdInvoice(),
                detail.getInvDetLine(), detail.getInvProdid(), new BigDecimal(
                detail.getInvQty().doubleValue() * Figures.INVERSE),
                detail.getInvMeasure(), detail.getInvPrice(),
                detail.getInvVat(), detail.getInvComments(), true);
        createInvoiceDetail(newDetail);
    }
