...
public class CustomerController {
     ...
     * @return
     */
    public static boolean removeCustomer(final String id) {
        ...
        for (int i = 0; i < args.length; i++) {
            try {
                switch (i) {
                    ...
                    default:
                        throw new Exception("Error while creating SP removeOneCustomerdAllCustomer()");
                }
     ...
     *
     * @param filter [name*, Type, active]
     * @return Collection of Business objects (Customers)
     */
    public static Collection<Business> getCustomers(final String[] filter) {
     ...
     * @throws Exception
     */
    public static void prepareCustomer(final Customer customer, final Object[] args, final int[] argsType, final ArgIO[] argsIO, final int i) throws Exception {
        switch (i) {
            case 0: {
                // IN id char(15),
    ...
    public static boolean createCustomer(final Customer customer) {
        final int LENGTH = 17;
        callableStatement = new StringBuilder();
        callableStatement.append("{call createCustomer(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)}");
        facade = new DBFacade();
        final Object[] args = new Object[LENGTH];
        final int[] argsType = new int[LENGTH];
        final ArgIO[] argsIO = new ArgIO[LENGTH];
    ...
    public static boolean updateCustomer(final Customer customer) {
        final int LENGTH = 17;
        callableStatement = new StringBuilder();
        callableStatement.append("{call updateCustomer(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)}");
        facade = new DBFacade();
        final Object[] args = new Object[LENGTH];
        final int[] argsType = new int[LENGTH];
        final ArgIO[] argsIO = new ArgIO[LENGTH];
